...
public class BTPacket {
    ...
    public static final byte TYPE_READING_COUNT          = 8;
    public static final byte TYPE_READY_TO_RECEIVE       = 9;
    public static final byte TYPE_READING_PACKET         = 10;
    public static final byte TYPE_READINGS_RECEIVED      = 11;
    public static final byte TYPE_GET_MICROCLIMATE       = 12;
    public static final byte TYPE_SET_MICROCLIMATE       = 13;
    public static final byte TYPE_MICROCLIMATE_PACKET    = 14;
